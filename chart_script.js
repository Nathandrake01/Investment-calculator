...
function drawChart() {
  ...
  document.getElementsByName("investment")[0].innerHTML = numberWithCommas(Math.round(Data_array[Tenure][1])/100000);
  document.getElementsByName("mf_return")[0].innerHTML = numberWithCommas(Math.round(Data_array[Tenure][2]/100000));
